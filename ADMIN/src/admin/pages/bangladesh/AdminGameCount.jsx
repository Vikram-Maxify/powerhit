...
import {
    ...
    createGameCount,
    updateGameCount,
} from "../../redux/bangladesh/gameCountSlice";
import { getTicketTypes } from "../../redux/ticketTypeSlice";
import { motion, AnimatePresence } from "framer-motion";

const AdminBangladeshGameCount = () => {
    const dispatch = useDispatch();
    const { gameCounts, loading } = useSelector((state) => state.bangladeshGameCount);
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <div className="relative">
                                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-medium">BDT</span>
                                                <input
                                                    type="number"
                                                    step="0.01"
...
export default AdminBangladeshGameCount;